...
def build_train_meta(*, output_dir: str, cfg_dict: Mapping[str, Any], dataset_size_used: int) -> dict[str, Any]:
    return {
        ...
        "gpu": {"available": torch.cuda.is_available(), "name": torch.cuda.get_device_name(0) if torch.cuda.is_available() else None},
